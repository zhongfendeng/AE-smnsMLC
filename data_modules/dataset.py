...
class ClassificationDataset(Dataset):
    ...
    def _preprocess_sample(self, sample_str):
        ...
        sample = {'token': [], 'label': [], 'label_nestedlist':raw_sample['label_nestedlist']}
        for k in raw_sample.keys():
            ...
            elif k == 'label_nogroup':
                k = 'label'
                sample[k] = []
                for v in raw_sample['label_nogroup']:
        ...
        padding = [0 for _ in range(0, self.max_input_length - len(sample['token']))]
